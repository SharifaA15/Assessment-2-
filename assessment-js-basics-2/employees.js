...
class Manager extends Employee {
    constructor(user, employees) {
      super(user);
      this.employees = employees;
    }
  
    getEmployees() {
      const allEmployees = this.employees.join(", ");
      console.log(this.name + " manages " + allEmployees);
    }
...
//CODE HERE 
manager.addEmployee("Sara");
manager.addEmployee("Shay");
/*
    Call the `getEmployees` method on the
